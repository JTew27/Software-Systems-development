...
public class RightTriangle extends Shape {
	...
	public double getPerimeter() {
		...
		double sideC = Math.sqrt((this.sideA * this.sideA)*(this.sideA * this.sideA));
	...
	public int getSideC() {
		...
		return (int) Math.sqrt((this.sideA * this.sideA)*(this.sideA * this.sideA));
	...
	public void expand(int multiplier) {
		...
		int MSideA = sideA * multiplier;
		int MSideB = sideB * multiplier;
		
		double sideC = Math.sqrt((this.sideA * this.sideA)*(this.sideA * this.sideA));
		int MSideC = (int) (sideC * multiplier);
	...
	public void contract(int divisor) {
		...
		int MSideA = sideA / divisor;
		int MSideB = sideB / divisor;
		
		double sideC = Math.sqrt((this.sideA * this.sideA)*(this.sideA * this.sideA));
		int MSideC = (int) (sideC * divisor);
	}
